...
new #[Layout('components.layouts.admin', ['title' => 'Suppliers'])] class extends Component {
    //
}; ?>
...
<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-2">
            <div class="relative w-full sm:w-80">
                ...
                <input type="text" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search suppliers...">
            </div>
    ...
    <!-- Suppliers Empty State Example -->
    <x-card>
        <x-empty-state 
            icon="truck" 
            title="No suppliers found" 
            description="You don't have any suppliers registered yet. Start by adding a new supplier to the network."
        >
            <x-slot name="action">
