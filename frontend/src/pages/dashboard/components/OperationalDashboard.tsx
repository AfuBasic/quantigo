...
export function OperationalDashboard({ user, t }: OperationalDashboardProps) {
  ...
  return (
    <div className="space-y-10">
      <section className="relative overflow-hidden rounded-[24px] border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] p-6 md:p-8 shadow-sm transition-all duration-300">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-q-green/10 border border-q-green/20 text-[10px] font-extrabold text-q-green uppercase tracking-wider">
                <ShieldCheck size={12} /> KYB {t("verifiedOperational")}
              </span>
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-[10px] font-bold text-slate-500 dark:text-white/60 capitalize">
            ...
            <p className="text-sm text-slate-500 dark:text-white/60 font-medium">
              ...
              <span className="font-extrabold text-slate-900 dark:text-white">
                {user?.merchant_profile?.business_name ?? user?.name}
              </span>
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-4 bg-slate-50 dark:bg-[#111827] p-4 rounded-2xl border border-slate-200 dark:border-white/10">
            <div className="space-y-0.5">
              <span className="block text-[10px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-wider">
                {t("nextActionRequired")}
              </span>
              <span className="text-xs font-extrabold text-slate-800 dark:text-white">
                Join consolidation batch
              </span>
            </div>
            <Link
              to="/pools"
